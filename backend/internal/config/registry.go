...
var settings = []Setting{
	...
	{"metadata_backfill", KindRuntime, TypeBool, ScopeFullRestart, editable, "On startup, AniList-search library titles that have no metadata link. New titles still match when added. Off by default.", boolGet(func(c *Config) *bool { return &c.MetadataBackfill }), boolSet(func(c *Config) *bool { return &c.MetadataBackfill })},
